...
function lessTask(root, inputFile) {
    return function() {
...
function watchTask(root) {
    return function() {
        gulp.watch(path.join(root, 'css/**/*.less'), ['less']);
        gulp.watch([
...
gulp.task('less', lessTask(ROOT, 'base.less'));
gulp.task('browserify', browserifyTask(ROOT, 'main.js'));
gulp.task('build', ['less', 'browserify', 'sync-static-assets', 'vendor-build-js']);
